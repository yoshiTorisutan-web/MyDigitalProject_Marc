...
class MeatAndFishPage extends StatefulWidget {
  const MeatAndFishPage({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _MeatAndFishPageState createState() => _MeatAndFishPageState();
}

class _MeatAndFishPageState extends State<MeatAndFishPage> {
  ...
  Future<void> _fetchProducts() async {
    final url = Uri.parse(
        'https://api.spoonacular.com/food/products/search?apiKey=e7d8103d0f674050924ec567074b3e0a&query=fish');
